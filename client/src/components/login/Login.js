    ...
    return (
        <div className="h-full flex flex-row relative overflow-hidden bg-cover" style={{ backgroundImage: `url(https://i.pinimg.com/originals/24/cc/eb/24cceb9cdcb03120898e70e2b42fc37d.jpg)` }}>
            <div className="grow relative w-1/2 xl:block hidden">
                ...
                <div className="text-white font-semibold text-2xl tracking-tight m-52">Lost In Liminal Space</div>
            </div>
            <div className="grow flex items-center xl:justify-center w-1/2 flex-col xl:bg-[rgba(0,0,0,.5);] bg-gradient-to-t from-[rgba(0,0,0,.8)] to-[rgba(0,0,0,.2)]">
                <div className="flex flex-col items-center xl:mt-0 xl:justify-center mt-36 gap-5 text-center">
                    ...
                    <a className="text-white bg-[#292f5e] rounded px-14 py-1.5 flex items-center gap-4" href="http://localhost:3000/auth"><img className="w-10 inline" src="https://assets-global.website-files.com/6257adef93867e50d84d30e2/636e0a6a49cf127bf92de1e2_icon_clyde_blurple_RGB.png" alt=""/>Login With Discord</a>
                </div>
            </div>
        </div>
    )
